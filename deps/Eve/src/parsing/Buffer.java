...
public class Buffer implements AbstractBuffer {
   ...
   public void advance() {
	 ...
	 *           up to, but not including, the next end-of-line, or end-of-file, whichever
	 *           occurs first</td>
	...
	public String getToDelimiter(String delim) {
		...
		for (int i =0; i < delim.length()-1; i++) advance();  // skip delim
		advance();
	...
	public static void main (String[] args) {
      ...
      check(b.currentPos()== 16 , "currentPos() should return the buffer position");
