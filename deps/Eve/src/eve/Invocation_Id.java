...
public class Invocation_Id extends EveInstruction {

	private static String rule = "<Invocation> ::= <Id>";
   ...
   private String id;
	...
	public Instruction createInstruction(InstructionList il) {
		Invocation_Id alg = new Invocation_Id();
		alg.id = il.getFirst().toString(); // just want the id; its value will be
		                                              // assigned later
		return alg;
