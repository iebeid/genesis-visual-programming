...
public class FormalParameterList_FormalParameter extends EveInstruction {

	private static String rule = "<FormalParameterList> ::= <FormalParameter> ";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new FormalParameterList_FormalParameter(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public FormalParameterList_FormalParameter(){ }
