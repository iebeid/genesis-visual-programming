...
public class ParameterList extends EveInstruction {

	private static String rule = "<ParameterList> ::= <Parameter> <Separator> <ParameterList>";
   ...
   public ParameterList(){ il = new InstructionList(); }
   public ParameterList (InstructionList il) {this.il = il;}
	public ParameterList (Instruction instr){
		il = new InstructionList();
		il.add (instr);
	}
	@Override
	public Instruction createInstruction(InstructionList il) {
		this.il = ((ParameterList)il.get(2)).getInstructionList();
	...
	// Hmm evaling a parameter list creates ... a ListVal  (have to think about this)
	@Override
