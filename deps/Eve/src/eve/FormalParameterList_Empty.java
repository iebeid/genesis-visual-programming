...
public class FormalParameterList_Empty extends EveInstruction {

	private static String rule = "<FormalParameterList> ::=  ";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new FormalParameterList_Empty(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public FormalParameterList_Empty(){ }
