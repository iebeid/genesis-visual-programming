...
public class Expression_FunctionDefinition extends EveInstruction {

	private static String rule = "<Expression> ::= <FunctionDefinition> ";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new Expression_FunctionDefinition(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public Expression_FunctionDefinition(){ }
