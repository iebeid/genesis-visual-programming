...
public class ComparisonOp_NE extends GenesisInstruction
   ...
   private final static ComparisonOp_NE COMPARISON_OP__NE = new ComparisonOp_NE();
   ...
   public ComparisonOp_NE(){ }
	...
	public StickyNote eval(StickyNote lhs, StickyNote rhs) {
         return new StickyNote(((Compare)(lhs.getVal())).ne( rhs.getVal() ));
	}
}
