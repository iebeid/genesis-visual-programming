...
public class ComparisonOp_GT extends GenesisInstruction
   ...
   private final static ComparisonOp_GT COMPARISON_OP__GT = new ComparisonOp_GT();
   ...
   public ComparisonOp_GT(){ }
	...
	public StickyNote eval(StickyNote lhs, StickyNote rhs) {
            return new StickyNote(((Compare)(lhs.getVal())).gt( rhs.getVal() ));
	}
}
