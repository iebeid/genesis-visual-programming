...
public class Primary_Unqualified extends GenesisInstruction {

	private static String rule = "<Primary> ::=  <UnsignedPrimary> ";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new Primary_Unqualified(),
				  new GenericParser(syntaxRule.lhs()));
	}

   public Primary_Unqualified(){ }

	/**
	 *
	 * @param il
	 * @return Returns the instruction represented by &lt;UnsignedPrimary>&gt;	 */
	@Override
