...
public class ConditionPrimary extends GenesisInstruction {

	private static String rule = "<ConditionPrimary> ::= <Condition>";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new ConditionPrimary(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public ConditionPrimary(){ }
