 ...
 * @author Larry Morell
 */
public class Term_MultOp extends GenesisInstruction {
	...
	public Instruction createInstruction(InstructionList il) {
		...
		Term_MultOp exp = new Term_MultOp();
		...
		if (third instanceof Term_MultOp) {
			Term_MultOp term = (Term_MultOp) third;
   ...
   /**
	 * Evaluate the sequence of multiplies and divides from left to right
	 * @return The value computed by applying the operators left to right to
	 *         the interspersed operands
	 */
	@Override
