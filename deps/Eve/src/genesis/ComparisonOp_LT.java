...
public class ComparisonOp_LT extends GenesisInstruction
   ...
   private final static ComparisonOp_LT COMPARISON_OP__LT = new ComparisonOp_LT();
   ...
   public ComparisonOp_LT(){ }
	...
	public StickyNote eval(StickyNote lhs, StickyNote rhs) {
          return new StickyNote(((Compare)(lhs.getVal())).lt( rhs.getVal() ));
	}
}
