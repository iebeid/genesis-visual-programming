...
public class UnsignedPrimary_Expression extends GenesisInstruction {

	private static String rule = "<UnsignedPrimary> ::= ( <Expression> ) ";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new UnsignedPrimary_Expression(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public UnsignedPrimary_Expression(){ }
