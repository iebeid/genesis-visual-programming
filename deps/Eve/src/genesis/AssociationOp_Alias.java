...
public class AssociationOp_Alias extends GenesisInstruction {

	private static String rule = "<AssociationOp_Alias> ::= alias";
	...
	public static void initialize() {  // static initialization
		GRAMMAR.addRule(syntaxRule,
				  new AssociationOp_Alias(),
				  new GenericParser(syntaxRule.lhs()));
	}
   public AssociationOp_Alias(){ }
