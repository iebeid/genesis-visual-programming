...
class PascalTextReader {
   ...
   PascalTextReader (String fileName) {
      ...
      try {
         if (infileName.equals("")) {
            ...
            //System.out.println("Using "+infileName);
   ...
   public char readChar() {
      try {
        infile.mark(1);
        ch=infile.read();
        if (ch == -1) eof = true;  // flag for eof function
      }
      catch (IOException e) { 
         System.out.println("Input error:");
         System.out.println(e);
   ...
   public String readLine() {
	...
	if (c == '\r')
		readChar();
      //System.out.println("Returning " + line + " from readLine()");
      return line; 
   }

   public static void main (String args[]){
      PascalTextReader in = new PascalTextReader(""); // from keyboard
      // PascalTextReader fin = new PascalTextReader("input.dat"); // from keyboard
      PrintStream out = System.out;
      int i=0;
      float f; double d; long l; char c;
      out.print("Enter a char immediately followed by a float: ");
      c= in.readChar();
    
      out.println("Your character was " + c  );
      f=in.readFloat();
      out.println("Your number was " + f);

      out.print("Enter an integer: ");
      i=in.readInt();
      out.println("Your number was " + i);

      out.print("Enter a long integer: ");
      l=in.readLong();
      out.println("Your number was " + l);

      out.print("Enter a float: ");

      f=in.readFloat();
      out.println("Your number was " + f);
      out.print("Enter a double: ");
      d=in.readDouble();
      out.println("Your number was " + d);
      out.print("Enter a full line: ");
      in.readLine();
      String line=in.readLine();
      out.println("Your line was " + line);
