...
class StickyNote
{
  ...
  void display() {System.out.print(this.toString());}
  void displayln() {System.out.println(this.toString());}
  StickyNote copy() { return new StickyNote(this);}
  String addr() {return super.toString();}
 
  GenesisVal getLabel() {return label;}
  void setLabel(GenesisVal label) {this.label = label; }
...
class StringVal extends GV
{
  ...
  public GV add( GV rhs )
  {
    if (rhs instanceof DoubleVal) 
       ...
       gl.reset(); gl.insert(new StickyNote (this));
       System.out.println( "GL = "+ gl);
       return gl;
    }
    else
...
class OpVal extends GenesisVal
{
  ...
  public static int highestPrec() { return highest; }
...
class TruthVal extends GV
{
  ...
  TruthVal (TruthVal tv) { val = tv.val;}

  TruthVal (boolean b) { val = b;}
  public String toString()
  {
    return String.valueOf( val );
  }
